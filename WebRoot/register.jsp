			...
			<div class="content">
				...
				<div class="login_box">	
					...
					<div class="login_form">
						...
						<form action="registerCheck.jsp" onsubmit="return validateCode()" class="form1" method="post">
							...
							<div class="ececk_warning"><span>密码不能为空</span></div>
								...
								<div class="form_text_ipt">
									<input class="mailAddress" id="repassword" name="mailAddress" type="text" placeholder="邮箱">
								</div>
